...
from ModelLib.tresnet.layers.anti_aliasing import AntiAliasDownsampleLayer
from ModelLib.tresnet.layers.avg_pool import FastGlobalAvgPool2d
from ModelLib.tresnet.layers.space_to_depth import SpaceToDepthModule
from ModelLib.tresnet.layers.squeeze_and_excite import SEModule

from ModelLib.inplace_abn import InPlaceABN
from ModelLib.inplace_abn import ABN
...
def TResnetL_V2(num_classes=196):
    """Constructs a large TResnet model.
    """
    in_chans = 3
    remove_model_jit = False

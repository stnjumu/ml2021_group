...
if __name__ == "__main__":
    ...
    files = ['Aug1_EfficientNetL_384.txt', 'Aug1_FocalLoss.txt', 'Aug1_Norm.txt', 'Aug1_ResNest_E48.txt', 'Aug2_EfficientNetL_468.txt', 'Aug2_ResNest_L200.txt', 'ResNest269E35.txt']
